...
$Event(0, Default, function () {
    ...
    $InitializeEvent(0, 46008000);
    $InitializeEvent(0, 46008100);
    $InitializeEvent(0, 46008200);
    $InitializeEvent(0, 46008400);
    $InitializeEvent(0, 46000401);
    $InitializeEvent(0, 46000402);
    $InitializeEvent(0, 46000403);
    $InitializeEvent(0, 46000404);
    $InitializeEvent(0, 46000405);
    $InitializeEvent(0, 46000406);
    $InitializeEvent(0, 46000407);
    $InitializeEvent(0, 46008002);
    $InitializeEvent(0, 46008003);
    $InitializeEvent(0, 46008102);
    $InitializeEvent(0, 46008203);
    $InitializeEvent(0, 46008204);
    $InitializeEvent(0, 46008205);
    $InitializeEvent(0, 46008206);
    $InitializeEvent(0, 46008207);
    ...
    $InitializeEvent(0, 9941);
    $InitializeEvent(0, 9943);
...
// 【デバッグ】地図全入手 -- [Debug] Obtain all maps
...
// 【デバッグ】篝火ワープ解禁 -- [Debug] Bonfire warp unlocked
...
// 【デバッグ】調合レシピ解禁 -- [Debug] Synthesis recipe unlocked
$Event(9943, Default, function () {
    WaitFor(EventFlag(9993));
    AwardItemsIncludingClients(100400);
});

// 【デバッグ】ゲスト追従ワープ -- [Debug] Guest following warp
...
//give resureccting ashes
$Event(46008000, End, function () {
    DisableNetworkSync();
    EndIf(PlayerHasItem(ItemType.Goods, 4600000));
    AwardItemLot(46000000);
    EndEvent();
});

//give golden rebirth
$Event(46008100, End, function () {
    DisableNetworkSync();
    EndIf(PlayerHasItem(ItemType.Goods, 4600100));
    AwardItemLot(46000100);
    EndEvent();
});

//give infinity pouch
$Event(46008200, End, function () {
    DisableNetworkSync();
    EndIf(PlayerHasItem(ItemType.Goods, 4600200));
    AwardItemLot(46000200);
    EndEvent();
});

//give impalers promise
$Event(46008400, End, function () {
    DisableNetworkSync();
    EndIf(PlayerHasItem(ItemType.Goods, 4600400));
    AwardItemLot(4600400);
    EndEvent();
});


//give targrays duty
$Event(46000401, End, function () {
    DisableNetworkSync();
    EndIf(PlayerHasItem(ItemType.Goods, 4600500));
    AwardItemLot(4600500);
    EndEvent();
});

//give DC item
$Event(46008204, Restart, function () {
    DisableNetworkSync();
    EndIf(PlayerHasItem(ItemType.Goods, 4600300));
    AwardItemLot(4600300);
    EndEvent();
});

//give items'a plenty item
$Event(46000407, Restart, function () {
    DisableNetworkSync();
    EndIf(PlayerHasItem(ItemType.Goods, 4600700));
    AwardItemLot(4600700);
    EndEvent();
});

//resureccting ashes end early
$Event(46008205, Restart, function () {
    DisableNetworkSync();
    WaitFor(CharacterHasSpEffect(10000, 46000002) || CharacterHasSpEffect(10000, 46000003));
...
//golden rebirth effect
$Event(46008102, Restart, function () {
    DisableNetworkSync();
    WaitFor(CharacterHasSpEffect(10000, 46000100));
    //every law of regression effect
    SetSpEffect(10000, 1673000);
    SetSpEffect(10000, 1673001);
    SetSpEffect(10000, 1673002);
    SetSpEffect(10000, 1673003);
    SetSpEffect(10000, 1673004);
    SetSpEffect(10000, 1673005);
    SetSpEffect(10000, 1673006);
    SetSpEffect(10000, 1673007);
    SetSpEffect(10000, 1673008);
    SetSpEffect(10000, 1673009);
    SetSpEffect(10000, 1673010);
    SetSpEffect(10000, 1673011);
    SetSpEffect(10000, 1673012);
    SetSpEffect(10000, 1673013);
    SetSpEffect(10000, 1673014);
    SetSpEffect(10000, 1673015);
    SetSpEffect(10000, 1673016);
    SetSpEffect(10000, 1673017);
    SetSpEffect(10000, 1673018);
    SetSpEffect(10000, 1673019);
    SetSpEffect(10000, 1673020);
    SetSpEffect(10000, 1673021);
    SetSpEffect(10000, 1673022);
    SetSpEffect(10000, 1673023);
    SetSpEffect(10000, 1673024);
    SetSpEffect(10000, 1673025);
    SetSpEffect(10000, 1673026);
    SetSpEffect(10000, 1673027);
    SetSpEffect(10000, 1673028);
    SetSpEffect(10000, 1673029);
    SetSpEffect(10000, 1673030);
    SetSpEffect(10000, 1673031);
    SetSpEffect(10000, 1673032);
    SetSpEffect(10000, 1673033);
    SetSpEffect(10000, 1673034);
    BonfirelikeRecovery();
    //force out of anim 1 frame after
    WaitFixedTimeRealFrames(1);
    ForceAnimationPlayback(10000, 0, false, false, false);
    WaitFixedTimeRealFrames(5);
    RestartEvent();
...
//braid of marika toggle, delay version
$Event(46008003, Restart, function () {
    DisableNetworkSync();
    WaitFor(CharacterHasSpEffect(10000, 46000001));
    ClearSpEffect(10000, 46000001);
    if (!CharacterHasSpEffect(10000, 46000000)) {
        SetSpEffect(10000, 46000000);
        WaitFixedTimeFrames(15);
        SetSpEffect(10000, 46000002);
        RestartEvent();
    }
    ClearSpEffect(10000, 46000000);
    WaitFixedTimeFrames(15);
    SetSpEffect(10000, 46000003);
    RestartEvent();
});

//braid of marika respawn toggle
$Event(46008002, Restart, function () {
    DisableNetworkSync();
    WaitFor(CharacterHasSpEffect(10000, 46000000) && CharacterHPValue(10000) < 1);
...
//infinity pouch toggle
$Event(46008203, Restart, function () {
    DisableNetworkSync();
    WaitFor(CharacterHasSpEffect(10000, 46000201));
    ClearSpEffect(10000, 46000201);
    if (!CharacterHasSpEffect(10000, 46000200)) {
        SetSpEffect(10000, 46000200);
        SetSpEffect(10000, 46000202);
        WaitFixedTimeFrames(5);
        RestartEvent();
    }
    ClearSpEffect(10000, 46000200);
    SetSpEffect(10000, 46000203);
    WaitFixedTimeFrames(5);
    RestartEvent();
});

//blue team TRIGGER ON/OFF
$Event(46000402, Restart, function () {
    RestartEvent();
    EnableNetworkSync();
    WaitFor(CharacterHasSpEffect(10000, 46000501));//wait for the trigger
    ClearSpEffect(10000, 46000402);//clear red
    if (CharacterHasSpEffect(10000, 46000502)) {
        WaitFixedTimeFrames(1);
        ClearSpEffect(10000, 46000502);
    }
    RestartEvent();
});

//red team TRIGGER ON/OFF
$Event(46000405, Restart, function () {
    RestartEvent();
    EnableNetworkSync();
    WaitFor(CharacterHasSpEffect(10000, 46000401));//wait for the trigger
    ClearSpEffect(10000, 46000502);//clear blue
    if (CharacterHasSpEffect(10000, 46000402)) {
        WaitFixedTimeFrames(1);
        ClearSpEffect(10000, 46000402);
    }
    RestartEvent();
});

//dc item effect
$Event(46000403, Default, function () {
    EnableNetworkSync();
    WaitFor(CharacterHasSpEffect(10000, 46000300));
    if (PlayerIsInOwnWorld()) {
        SendAllPhantomsHome(0);
    } else {
        DisplayNetworkMessage(2631424, true);
        SendInvadingPhantomsHome(0);
    }
    RestartEvent();
});

//external is_own_world flag
$Event(46008206, Restart, function () {
    if (PlayerIsInOwnWorld()) {
        SetSpEffect(10000, 4600600);
    } else {
        ClearSpEffect(10000, 4600600);
    }
    RestartEvent();
});
...
//set arena color
$Event(46008207, Restart, function () {
    RestartEvent();
    WaitFor(ArenaMatchReadyState(1));
    //1v1 colors
    if (HasArenaMatchType(ArenaMatchType.OneVersusOne, false) || HasArenaMatchType(ArenaMatchType.OneVersusOne, true)) {//is 1v1
        if (PlayerIsInOwnWorld()) {
            SetSpEffect(10000, 46000402);//set red
        }
        if (!PlayerIsInOwnWorld()) {
            SetSpEffect(10000, 46000502);//set blue
        }
    }
    RestartEvent();
});
...
//remove message item
$Event(46000406, Restart, function () {
    DisableNetworkSync();
    if (PlayerHasItem(ItemType.Goods,106)){
        RemoveItemFromPlayer(ItemType.Goods, 106, 1);
    }
    RestartEvent();
});

//
$Event(46000404, Default, function () {
    RestartEvent();
});
